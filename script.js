...
// Cores
const BLUE =   { r: 38, g: 152, b: 225 };
const GREEN =  { r: 9, g: 176, b: 33 };
const PINK =   { r: 233, g: 41, b: 132 };
const ORANGE = { r: 255, g: 123, b: 32 };
...
function computePolyNormal(poly, normalName) {
	...
	// Calcular a magnitude do normal e normalizar
...
function renderScoreHud() {
	...
	cubeCountNode.innerText = `CUBOS DESTRUÍDOS: ${state.game.cubeCount}`;
}
	...
	switch (state.menus.active) {
		...
		case MENU_SCORE:
			...
			if (isNewHighScore()) {
				...
				highScoreLblNode.textContent = `Recorde: ${formatNumber(getHighScore())}`;
			}
